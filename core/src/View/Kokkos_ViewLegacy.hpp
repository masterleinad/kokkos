...
#undef KOKKOS_IMPL_VIEW_OPERATOR_VERIFY
 ...
 public:
  ...
  explicit KOKKOS_INLINE_FUNCTION View(
    ...
    auto prop_copy = Impl::with_properties_if_unset(arg_prop, typename traits::memory_space{});
    Impl::runtime_check_memory_space(Impl::get_property<Impl::PointerTag>(prop_copy)
