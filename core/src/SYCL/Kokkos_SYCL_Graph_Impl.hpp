...
class GraphImpl<Kokkos::Experimental::SYCL> {
 public:
  using node_details_t = GraphNodeBackendSpecificDetails<Kokkos::Experimental::SYCL>;
  using root_node_impl_t =
      GraphNodeImpl<Kokkos::Experimental::SYCL, Kokkos::Experimental::TypeErasedTag,
...
template <class... PredecessorRefs>
inline auto GraphImpl<Kokkos::Experimental::SYCL>::create_aggregate_ptr(PredecessorRefs&&...) {
