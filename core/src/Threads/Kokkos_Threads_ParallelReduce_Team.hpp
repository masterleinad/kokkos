 ...
 public:
  ...
  inline ParallelReduce(const CombinedFunctorReducerType &arg_functor_reducer,
    ...
    if ((arg_policy.scratch_size(0, m_policy.team_size()) +
      ...
      error << "Kokkos::parallel_reduce<Threads>: Requested too much scratch memory on level 0. Requested: "
    ...
    if (arg_policy.scratch_size(1, m_policy.team_size()) >
      ...
      std::stringstream error;
      error << "Kokkos::parallel_reduce<Threads>: Requested too much scratch memory on level 1. Requested: "
