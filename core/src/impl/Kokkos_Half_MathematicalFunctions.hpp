...
#if defined(KOKKOS_IMPL_SYCL_BHALF_TYPE_DEFINED) && defined(KOKKOS_ENABLE_SYCL)
  KOKKOS_IMPL_MATH_H_FUNC_WRAPPER(KOKKOS_IMPL_MATH_UNARY_FUNCTION_HALF_TYPE, fabs)
#else
...
// fma
#if defined(KOKKOS_IMPL_SYCL_BHALF_TYPE_DEFINED) && defined(KOKKOS_ENABLE_SYCL)
  KOKKOS_IMPL_MATH_H_FUNC_WRAPPER(KOKKOS_IMPL_MATH_BINARY_FUNCTION_HALF, fmax)
  KOKKOS_IMPL_MATH_H_FUNC_WRAPPER(KOKKOS_IMPL_MATH_BINARY_FUNCTION_HALF, fmin)
#else
...
#if defined(KOKKOS_IMPL_SYCL_BHALF_TYPE_DEFINED) && defined(KOKKOS_ENABLE_SYCL)
KOKKOS_IMPL_MATH_H_FUNC_WRAPPER(KOKKOS_IMPL_MATH_UNARY_PREDICATE_HALF, isnan)
#else
