...
void warn_deprecated_environment_variable(const std::string& deprecated);
void warn_deprecated_environment_variable(const std::string& deprecated,
                                          const std::string& use_instead);
void warn_deprecated_command_line_argument(const std::string& deprecated);
void warn_deprecated_command_line_argument(const std::string& deprecated,
                                           const std::string& use_instead);
void warn_not_recognized_command_line_argument(
