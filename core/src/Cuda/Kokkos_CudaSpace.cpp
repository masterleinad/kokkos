...
void DeepCopyAsyncCuda(void *dst, const void *src, size_t n) {
  ...
  KOKKOS_IMPL_CUDA_SAFE_CALL(
    ...
    Kokkos::Tools::Experimental::Impl::profile_fence_event<Kokkos::Cuda>(
      "Kokkos::Impl::DeepCopyAsyncCuda: Deep Copy Stream Sync", Kokkos::Tools::Experimental::SpecialSynchronizationCases::
...
void *impl_allocate_common(const Cuda &exec_space, const char *arg_label,
  ...
  const Impl::CudaInternal& cuda_internal = *exec_space.impl_internal_space_instance();
...
#error CUDART_VERSION undefined!
  ...
  if (arg_alloc_size >= memory_threshold_g) {
   error_code =
          cuda_internal.cuda_malloc_async_wrapper(
              &ptr, arg_alloc_size);
    ...
    error_code =
             cuda_internal.cuda_malloc_wrapper(
                   &ptr, arg_alloc_size);
  }
#else
  (void)exec_space_provided;
  error_code = cuda_internal.cuda_malloc_wrapper(
        &ptr, arg_alloc_size);
#endif
