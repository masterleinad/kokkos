...
* simd: Fix compilation when ranges are not available [\#9065](https://github.com/kokkos/kokkos/pull/9065)
...
* simd: Fix `simd::reduce` with an abi other than scalar [\#9079](https://github.com/kokkos/kokkos/pull/9079)
...
* Atomics: fix warning with lock free fetch op on pointers [\#9086](https://github.com/kokkos/kokkos/pull/9086)
* Reduce overhead for RangePolicy when StaticBatchSize is 1 [\#9123](https://github.com/kokkos/kokkos/pull/9123), [\#9124](https://github.com/kokkos/kokkos/pull/9124)
