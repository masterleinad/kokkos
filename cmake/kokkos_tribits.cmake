...
function(KOKKOS_SET_LIBRARY_PROPERTIES LIBRARY_NAME)
  ...
  if(NOT (KOKKOS_CXX_COMPILER_ID STREQUAL NVHPC)
    ...
    separate_arguments(CMAKE_FLAGS_SEPARATED UNIX_COMMAND ${CMAKE_${KOKKOS_COMPILE_LANGUAGE}_FLAGS})
    list(APPEND ALL_KOKKOS_COMPILER_FLAGS ${CMAKE_FLAGS_SEPARATED})
    separate_arguments(CMAKE_LINKER_FLAGS_SEPARATED UNIX_COMMAND ${CMAKE_EXE_LINKER_FLAGS})
    list(APPEND ALL_KOKKOS_LINK_OPTIONS ${KOKKOS_LINK_OPTIONS} ${CMAKE_LINKER_FLAGS_SEPARATED})
    kokkos_check_flags(
      LANGUAGE ${KOKKOS_COMPILE_LANGUAGE} FLAGS ${ALL_KOKKOS_COMPILER_FLAGS} LINKER_FLAGS ${ALL_KOKKOS_LINK_OPTIONS}
    )
  endif()
