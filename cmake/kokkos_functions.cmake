...
FUNCTION(kokkos_option CAMEL_SUFFIX DEFAULT TYPE DOCSTRING)
  ...
  LIST(APPEND KOKKOS_OPTION_TYPES "${DOCSTRING}")
...
FUNCTION(kokkos_set_option CAMEL_SUFFIX VALUE)
  MESSAGE(STATUS "FIND KEYS: ${KOKKOS_OPTION_KEYS}")
  ...
  MESSAGE(STATUS "${KOKKOS_OPTION_KEYS}")
  MESSAGE(STATUS "${KOKKOS_OPTION_VALUES}")
  MESSAGE(STATUS "${KOKKOS_OPTION_TYPES}")

  list(GET KOKKOS_OPTION_VALUES ${OPTION_INDEX} DOCSTRING)
  list(GET KOKKOS_OPTION_TYPES ${OPTION_INDEX} TYPE)
  MESSAGE(STATUS "${OPTION_INDEX} DOCSTRING: ${DOCSTRING}")
