...
IF (DEFINED KOKKOS_COMPILER_CUDA_VERSION AND KOKKOS_COMPILER_CUDA_VERSION GREATER_EQUAL 80)
  SET(CONSTEXPR_DEFAULT ON)
ELSE()
  SET(CONSTEXPR_DEFAULT OFF)
ENDIF()
KOKKOS_ENABLE_OPTION(CUDA_CONSTEXPR ${CONSTEXPR_DEFAULT} "Whether to activate experimental lambda features")
